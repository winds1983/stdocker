...
```shell
python3 -m pip install stdocker==1.0.6
```
...
```
+---------------+-------------+------------+-----+-------+------------+---------------+------------+-------+---------------+----------+-------------+--------+---------------+------------+-------+
|               |  Env Code   | Web Server | PHP | MySQL | phpMyAdmin | Elasticsearch | Elasticvue | Redis | phpRedisAdmin | RabbitMQ | Mailcatcher | Mongdo | Mongo Express | PostgreSQL | pgweb |
+---------------+-------------+------------+-----+-------+------------+---------------+------------+-------+---------------+----------+-------------+--------+---------------+------------+-------+
...
+---------------+-------------+------------+-----+-------+------------+---------------+------------+-------+---------------+----------+-------------+--------+---------------+------------+-------+
|   Full LNMP   |    full     |   nginx    | 7.4 |  8.0  |     Y      |     7.16      |     Y      |  6.2  |       Y       |   3.9    |      Y      |   N    |       Y       |     N      |   N   |
+---------------+-------------+------------+-----+-------+------------+---------------+------------+-------+---------------+----------+-------------+--------+---------------+------------+-------+
...
The red row is your current environment.
